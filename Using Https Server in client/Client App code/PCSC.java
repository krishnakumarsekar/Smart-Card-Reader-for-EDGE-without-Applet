...
public class PCSC {
    ...
    public static void main(String argv[]) {
        ...
        try {
            ...
            char[] password = "SCARDREADER".toCharArray();
            KeyStore ks = KeyStore.getInstance("JKS");
            //URL urlToDictionary = PCSC.class.getResource("bin/SCARDREADER.jks");
            //InputStream stream = urlToDictionary.openStream();
            //File file = new File(urlToDictionary.toURI());
            FileInputStream fis = new FileInputStream("SCARDREADER.jks");
            ...
            System.out.println("Failed to create HTTPS server on port " + 8001 + " of localhost");
        }
